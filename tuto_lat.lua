...
local tableText = {
	...
	negras = {
		...
		"Ahora oprime la baldosa para hacerla rotar y que hayan 2 porciones rojas en el rosal. (Solo rotará de manera que coincidan sus caminos con los de las baldosas contiguas)" ,
		"Ahora oprime el botón \"OK\" para aceptar y así completar el rosal.",
		"¡Bien hecho! Uno de tus soldados se moverá hasta la baldosa que acabas de colocar." ,
