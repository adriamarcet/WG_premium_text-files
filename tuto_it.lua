...
local tableText = {
	...
	negras = {
		...
		"Quando completi un rosaio, tutte le sue sezioni si coloreranno del colore dominante e il giocatore di quel colore segnerà 1 punto. Il rosaio sparirà se c'è un pareggio tra i colori.",
		"Posiziona e ruota la nuova tessera nella giusta posizione per completare il rosaio e segnare un punto!",
		"Ottimo! Hai segnato il tuo primo punto! ll vincitore sarà chi segna per primo 7 punti.\nMa fai attenzione! Nel frattempo, potresti far segnare punti anche agli altri giocatori.",
		"Tocca di nuovo a te! Sarebbe magnifico posizionare la tua nuova tessera qui, ma i soldati rivali ti bloccano la strada.\nPuoi posizionare le tessere sul tabellone solo se i tuoi soldati possono spostarsi su di esse.",
		"Ma c'è un modo per posizionare la tessera lì: metti in gioco il tuo secondo soldato!\nHai due soldati disponibili per ogni partita. Forza, aggiungiamo il secondo.",
		"Tocca il soldato per aggiungerlo alla tessera.",
		"Ora puoi posizionare la tessera in più posizioni e evitare che i soldati rivali ti blocchino.\nPosiziona la tessera nella posizione indicata, ruotala e accetta.",
		"Bel lavoro!\nEntrambi i soldati sono in gioco, uno sarà sempre sulla tessera che hai posizionato, mentre l'altro potrà essere spostato a piacimento e potrà essere usato per tentare di bloccare i tuoi avversari .",
		"Ora tocca la posizione indicata sul sentiero e il soldato si sposterà lì. Poi tocca il pulsante \"OK\" per confermare.",
		"Sei stato bloccato! L'unico modo per tirar fuori il soldato da quel guaio è recuperarlo dal giardino. \nSe sei bloccato, scartando una tessera nel cappello, potresti riuscire a recuperare un soldato a tua scelta dal tabellone.",
