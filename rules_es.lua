...
local tableText = {
	...
	negras = {
		...
		pieIlustracion1 = "Mayoria de rojo = Punto jugador rojo",
		pieIlustracion2 = "Igualdad de colores = Punto nulo",
		...
		pieIlustracion3 = "Arrastra la loseta al tablero",
		pieIlustracion4 = "Presiona en la loseta para rotar",
		...
		pieIlustracion5 = "Al descartar loseta recuperas  soldado",
		...
		pieIlustracion6 = "Aprieta el símbolo para transformar la loseta una vez por partida",
		...
		pieIlustracion7 = "Aprieta el icono de soldado para añadirlo a tu loseta actual",
			
			Pag7= "En el Modo Duelo se enfrentan solo el equipo rojo contra el equipo azul, y la victoria es para quien anote 5 puntos.\nAdemás hay dos torres en juego que los jugadores pueden mover para bloquear a su oponente. Las demás reglas son las mismas que en el Modo Clásico.\nAl completar un rosal con una mayoría de porciones blancas, recibes un movimiento de torre.\nAl final de tu turno, puedes mover una de las dos torres gastando un movimiento de torre.\nUna torre mueve de la misma forma que un soldado y bloquea el camino a todos los soldados en juego. Cuando hayas movido una de las torres y confirmado el movimiento apretando ”OK”, tu turno acabará inmediatamente. Si no quieres mover ninguna torre solo aprieta ”OK”).",
		
		pieIlustracion8 = "Ganas 1 punto de torre",
		pieIlustracion9 = "Puedes mover 1 torre gastando 1 punto de torre",
		--<< END translate >>--
	}
}
